...
- **代码作者**：xingma
- **操作系统**：Mac OS X
- **用户工作目录**：/Users/xingma/Documents/ChatGPT/ai-chat/jdk_21_demo
- **SDK 版本**：JDK 21.0.10
- **构建工具**：Maven
- **项目默认语言**：中文（所有代码注释请使用中文编写）

### 目录结构
项目当前的目录结构如下，新增代码请遵循此结构进行扩展：
```text
jdk_21_demo
    └── src
        └── main
...
- **主框架**：Spring Boot 3.x
- **语言版本**：Java 17 / Java 21 (当前环境为 JDK 21，注意使用兼容的语法与特性)
- **核心依赖**：
